...
Proof.
  intros. bexp_cases (induction b as [| | | |b IHb1|b1 IHb1 b2 IHb2]) Case;
    simpl;
...
Proof.
  ...
  - symmetry. apply neq_id. unfold not. intros. apply H. rewrite e. apply H0.
  - reflexivity.
Qed.
(** [] *)
