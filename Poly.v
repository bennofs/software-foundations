...
Example test_repeat1:
  repeat true 2 = cons true (cons true nil). reflexivity. Qed.
...
Proof. 
  ...
  Case "h :: t". simpl. rewrite IHt. reflexivity.
Qed.
...
Proof.
  ...
  induction l as [|h t].
  Case "nil". reflexivity.
  Case "h :: t". simpl. rewrite rev_snoc. rewrite IHt. reflexivity.
Qed.
...
Definition prod_uncurry {X Y Z : Type}
  (f : forall _ : X, forall _ : Y, Z) (p : X * Y) : Z := f (fst p) (snd p).
...
Definition filter_even_gt7 : forall (_ : list nat), list nat := 
  filter (fun x => andb (ble_nat 8 x) (evenb x)).

Example test_filter_even_gt7_1 :
  filter_even_gt7 [1;2;6;9;10;3;12;8] = [10;12;8]. reflexivity. Qed.
Example test_filter_even_gt7_2 :
  filter_even_gt7 [5;2;6;19;129] = []. reflexivity. Qed.
(** [] *)
...
Theorem map_snoc : 
  forall (X Y : Type) (f : X -> Y) (l : list X) (z : X),
  map f (snoc l z) = snoc (map f l) (f z).
Proof.
  intros.
  induction l as [|h t].
  Case "nil". reflexivity.
...
Proof.
  ...
  induction l as [|h t].
  Case "[]". reflexivity.
  Case "h :: t". simpl. rewrite map_snoc. rewrite IHt. reflexivity.
Qed. 
(** [] *)
...
(** Observe that the type of [fold] is parameterized by _two_ type
    ...
    different? *)
(* For implementing map using fold. *)
...
Proof.
  ...
  induction l as [|h t].
  Case "[]". reflexivity.
  Case "h :: t". unfold fold_map. simpl. fold (fold_map f t). rewrite IHt. reflexivity.
Qed.
